// Generated from MOC_Lexico.g4 by ANTLR 4.13.2
...
public class MOC_Lexico extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"INTEIRO", "DUPLO", "VAZIO", "FUNCAOPRINCIPAL", "SE", "SENAO", "ENQUANTO", 
			"PARA", "DEVOLVE", "LER", "LERCARACT", "LERVETOR", "LERCADEIA", "ESCREVER", 
			"ESCREVERCARACT", "ESCREVERVETOR", "ESCREVERCADEIA", "MAIS", "MENOS", 
			"MULTIPLICA", "DIVIDE", "RESTO", "MENOR", "MENORIGUAL", "MAIOR", "MAIORIGUAL", 
			"IGUAL", "DIFERENTE", "ELOGICO", "OULOGICO", "NAO", "ABREPARENTISES", 
	...
	public MOC_Lexico(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "MOC_Lexico.g4"; }
