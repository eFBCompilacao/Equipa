...
cd /d %LINGUAGEM%
java org.antlr.v4.Tool -o . %LEXICO% %PARSER%
...
:: Executar a Função AnalisarTokens, com base no Léxico
echo.
echo A correr a Função AnalisarTokens com %EXEMPLO%_proc.moc...
java -cp "%JAVA%;%LINGUAGEM%;%ANTLR%" AnalisadorTokens %EXEMPLOS%\%EXEMPLO%_proc.moc
