...
:: Executar a Função Principal, para gerar a Árvore
echo.
echo A correr a Função Principal com %EXEMPLO%_proc.moc...
java -cp "%JAVA%;%LINGUAGEM%;%ANTLR%" Principal %EXEMPLOS%\%EXEMPLO%_proc.moc
